...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Income=new income();
        ref=database.getInstance().getReference().child("income");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (img_uri == null) {
                    ...
                    Income.setDate(date.getText().toString());
                    Income.setTime(time.getText().toString());
                    Income.setImg_uri("無照片");

                    ref.push().setValue(Income);
                    Toast.makeText(MainActivity2.this,"新增成功",Toast.LENGTH_SHORT).show();
                }
                if (img_uri != null) {
                    uploadFile();
                    Toast.makeText(MainActivity2.this,"新增成功",Toast.LENGTH_SHORT).show();
        ...
        date.setOnTouchListener(new View.OnTouchListener(){
            public boolean onTouch(View v, MotionEvent event){
                ...
                new DatePickerDialog(MainActivity2.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        time.setOnTouchListener(new View.OnTouchListener(){
            public boolean onTouch(View v, MotionEvent event){
                ...
                new TimePickerDialog(MainActivity2.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private void uploadFile(){
        if(img_uri!=null){
            ...
            final StorageReference storageReference1=storageReference.child("income/"+ UUID.randomUUID().toString());
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    Uri dlUri = uri;
                                    income income=new income(name.getText().toString(),money.getText().toString(),date.getText().toString(),time.getText().toString(),dlUri.toString());
                                    ref.push().setValue(income);
                                }
                            });
                            Toast.makeText(MainActivity2.this,"上傳成功",Toast.LENGTH_SHORT).show();
                        }})
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(MainActivity2.this,"失敗："+e.getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    })
